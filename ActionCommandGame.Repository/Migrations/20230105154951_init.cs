    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NegativeGameEvent", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PositiveGameEvent",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositiveGameEvent", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Player_CurrentAttackPlayerItemId",
                table: "Player",
                column: "CurrentAttackPlayerItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Player_CurrentDefensePlayerItemId",
                table: "Player",
                column: "CurrentDefensePlayerItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Player_CurrentFuelPlayerItemId",
                table: "Player",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Player_PlayerItem_CurrentAttackPlayerItemId",
                table: "Player",
                column: "CurrentAttackPlayerItemId",
                principalTable: "PlayerItem",
                principalColumn: "Id");

            migrationBuilder.AddForeignKey(
                name: "FK_Player_PlayerItem_CurrentDefensePlayerItemId",
                table: "Player",
                column: "CurrentDefensePlayerItemId",
                principalTable: "PlayerItem",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Player_PlayerItem_CurrentFuelPlayerItemId",
                table: "Player",
                column: "CurrentFuelPlayerItemId",
                principalTable: "PlayerItem",
                principalColumn: "Id");
